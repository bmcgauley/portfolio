      ...
      <header className="mb-12 flex items-start justify-between gap-6">
        <div>
          ...
          <p className="font-serif italic text-body text-ink-soft mt-3">
            Manage consulting work, academic projects, and case studies. Drag
            the handle on the left to reorder.
          </p>
        </div>
        ...
        <SortableAdminList
          items={projects.map((project) => {
            ...
            return {
              id,
              node: (
                <div className="bg-vellum border-t-4 border-gold rounded-[2px] p-6">
