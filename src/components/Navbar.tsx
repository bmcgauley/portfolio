...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-secondary/30 bg-[#0a1929] shadow-md">
      <div className="container flex h-16 items-center justify-between">
        ...
        <Sheet open={open} onOpenChange={setOpen}>
          ...
          <SheetContent side="left" className="w-[80vw] sm:w-[350px] border-r border-border">
